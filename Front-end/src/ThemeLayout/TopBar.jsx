...
//images
import logo01 from "../logo.svg";
import icons01 from "../assets/images/icons/01.svg";
import user1 from "../assets/images/icons/03.png";
import avatar01 from "../assets/images/icons/03.png";
import user2 from "../assets/images/icons/03.png";
                        ...
                        <div className="header-inner-one">
                            <div className="left-logo-area">
                                <Link to="/" className="logo">
                                    <img src={logo01} alt="logo-image" style={{ maxWidth: '40px' }} />
                                </Link>
